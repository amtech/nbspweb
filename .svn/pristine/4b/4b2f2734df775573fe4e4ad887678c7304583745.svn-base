/**
 * jquery.timer.js 在网页上显示日期和时间控件 使用方法:$('#timeDisp').timer();
 * 
 * @author SuperBoy 日期格式说明: > > *yy: 四位年份,如:2009 > *y : 两位年份,如:09 > *mm:
 *         两位月份,不足在前补0,如:02 > *m : 一位月份,不补0,如:02 > *dd: 月份中的日,两位表示,不足补0,如:02 >
 *         *d : 月份中的日,不足补0,如:2 > *W : 星期的全称,如:星期一 > *w : 星期的略称,如:周一 >
 *         *HH:24小时制小时,不足两位补0,如:08,13 > *H:24小时制,不补0,如:8,13 > *hh:
 *         12小时制,不足两位补0并且会在加上am或pm进行区分,如01:12:20 am > *h :
 *         12小时制,不补0并且会在加上am或pm进行区分,如1:12:20 am > *MM:分钟表示,不足两位补0,如:08 >
 *         *M:分钟表示,不补0,如:8 > *ss:秒表示,不足两位补0,如:08 > *s:秒表示,不补0,如:8 > *SSS:表示毫秒 >
 */
(function($) {
function Timer(){
this._defaults = {
...
/**
 * yy: 四位年份,如:2009 y : 两位年份,如:09 mm: 两位月份,不足在前补0,如:02 m : 一位月份,不补0,如:02 dd:
 * 月份中的日,两位表示,不足补0,如:02 d : 月份中的日,不足补0,如:2 W : 星期的全称,如:星期一 w : 星期的略称,如:周一
 * HH:24小时制小时,不足两位补0,如:08,13 H:24小时制,不补0,如:8,13 hh:
 * 12小时制,不足两位补0并且会在加上am或pm进行区分,如01:12:20 am h :
 * 12小时制,不补0并且会在加上am或pm进行区分,如1:12:20 am MM:分钟表示,不足两位补0,如:08 M:分钟表示,不补0,如:8
 * ss:秒表示,不足两位补0,如:08 s:秒表示,不补0,如:8 SSS:表示毫秒
 */
