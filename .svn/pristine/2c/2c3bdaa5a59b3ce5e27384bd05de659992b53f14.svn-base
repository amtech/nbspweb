			...
			<div class="tabcontent">
				...
				<table border="0" align="center" cellpadding="3" cellspacing="0">
					...
					<tr>
						...
						<td colspan="3">&nbsp;&nbsp;
							${resultMap['APPRAISEMONTH']}&nbsp;&nbsp;${resultMap['ORGNAME']}&nbsp;&nbsp;${resultMap['REGIONNAME']}&nbsp;&nbsp;${resultMap['TABLE_NAME']}
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td colspan="3">&nbsp;&nbsp;
						    <input type="hidden" id="input_examresult_id" name="appealForm.examResultId" value="${resultMap['ID']}"/>
							<textarea class="required" rows="5" cols="142" id="input_cause" name="appealForm.cause">${resultMap['CAUSE']}</textarea>
