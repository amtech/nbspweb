...
var jqgrid=jQuery("#workordergrid").jqGrid({    
	url: "${ctx}/workflow/workOrderWaitHandledAction!listdata.action",   
	datatype: "json",mtype: 'POST',rownumbers: true,
	colNames:['工单标题','工单号','现场处理人','处理时限','工单类型', '派单人','派单时间','状态','操作','PID','PROCESS_URL'],
	colModel:[
	          ...
	          {name:'ID',id:'ID',sortable:false,formatter:WaitHandworkorderFmatter,width:80},
				...
				<div class="tabcontent">
					<table cellspacing="0" cellpadding="0" border="0" align="center">
						<tr>
							<th>标题：</th>
							<td>
								<input class="inputtext" type="text" style="width:220px;" id="workOrder_taskName" name="taskName" maxlength="60" />
							</td>
							<th>建单人：</th>
							<td>
						...
						<tr>
							...
							<th>工单类型：</th>
							<td>
								<baseinfo:dicselector id="workOrder_taskType" style="width:220px;" name="taskType" columntype="TASK_CODE" type="select" isQuery="query" cssClass="inputtext"></baseinfo:dicselector>
							</td>
						</tr>
						<tr>
							<td colspan="4" align="center">
								<input type="button" onclick="query();" class="button" value="查询" />
								<baseinfo:expexcel cls="exprotButton"  businessId="workorder_waithandled_list" name="导出excel"></baseinfo:expexcel>
							</td>
						</tr>
					</table>
				</div>
