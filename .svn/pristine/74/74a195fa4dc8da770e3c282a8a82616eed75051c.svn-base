		...
		jQuery("#tongji1")
				.click(
						function() {
							...
							var url = "${ctx}/monthcost/monthstatistical!staticByType.action?type=Check&lab=1&month="
									+ month + "&year=" + year;
							window.location = url;
		...
		jQuery("#tongji2")
				.click(
						function() {
							...
							var url = "${ctx}/monthcost/monthstatistical!staticByType.action?type=Check&lab=2&month="
									+ month + "&year=" + year;
							window.location = url;
		...
		jQuery("#tongji3")
				.click(
						function() {
							...
							var url = "${ctx}/monthcost/monthstatistical!staticByType.action?type=Check&lab=3&month="
									+ month + "&year=" + year;
							window.location = url;
...
<body>
	<div class="title_bg">
		<div class="title">当前位置-月度考核费用统计</div>
	</div>
		...
		<div class="tab-content"
			...
			<div class="tab-pane  <c:if test="${labq=='1'}"> active  </c:if>"
				...
				<p>
					...
					<input type="button" value="查询" id="tongji1" /> 
					<input
						type="button" value="导出"  onclick="exportLs('Check','1')"/>
				</p>
				<p>
				<table width="100%" height="98%" border="1" cellpadding="0"
					...
					<thead>
						<tr>
							...
							<td align="center"><strong>代维数量</strong></td>
			...
			<div class="tab-pane  <c:if test="${labq=='2'}"> active  </c:if>"
				...
				<p>
					年份:<select id="cyear" name="cyear"><option value="">--请选择--</option>
						...
						type="button" value="导出"  onclick="exportLs('Check','2')"/>
				</p>
				<p>
				<table width="100%" height="98%" border="1" cellpadding="0"
			...
			<div class="tab-pane  <c:if test="${labq=='3'}">active  </c:if>"
				...
				<p>
					年份:<select id="syear" name="syear"><option value="">--请选择--</option>
						...
						type="button" value="导出"  onclick="exportLs('Check','3')"/>
				</p>
				<p>
				<table width="100%" height="98%" border="1" cellpadding="0"
