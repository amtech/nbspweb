...
@Namespace("/assess")
@Results({
		@Result(name = "input", location = "/assess/monthappraise/assess_month_appraise_approve.jsp"),
		@Result(name = "list", location = "/assess/monthappraise/assess_month_appraise_approve_list.jsp") })
@Action("/assessMonthAppraiseApproveAction")
public class AssessMonthAppraiseApproveAction extends
	...
	public String save() {
		...
		super.addMessage("月度考核评分审核成功！", url, SysConstant.SUCCESS);
		return SUCCESS;
	}
