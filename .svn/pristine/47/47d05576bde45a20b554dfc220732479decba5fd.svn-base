		...
		<form action="${ctx }/assess/assessAppealFormWaitHandledAction!saveApprove.action" id="inputForm" name="inputForm" method="post">
			...
			<div class="tabcontent">
				<div id="tab_process" style="width: 99%; height: 99%">
						<ul>
							<li><a href="#auditHistoryTd">申诉信息</a></li>
							<li><a href="#confirmHistoryTd">考核信息</a></li>
						</ul>
						<div id="auditHistoryTd">
					...
					<tr>
						...
						<td colspan="3">&nbsp;&nbsp;
						  <fmt:formatDate value="${appealMap['CHECK_TIME']}"/>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td colspan="3">&nbsp;&nbsp;
						  <c:if test="${appealMap['CONFORM_RESULT']=='pass'}">通过</c:if>
						</td>
					</tr>
					<tr>
						<th>
			...
			<input type="hidden" name="appealForm.transition" value="pass" >
		</form>
	</body>
</html>