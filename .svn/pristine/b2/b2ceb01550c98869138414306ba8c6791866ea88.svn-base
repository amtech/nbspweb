...
In.add('wmaintain_common',{path:'${ctx}/workflow/wmaintain/js/wmaintain_common.js',type:'js',charset:'utf-8'});
	In.ready('jgcn', 'common', 'wdatejs', 'wmaintain_common', function() {
		...
		var jqgrid = jQuery("#wmaintaingrid")
				.jqGrid(
						{
							url : "${ctx}/workflow/wmaintainCancelAction!waitCancelListData.action?",
							datatype : "json",
							mtype : 'POST',
							rownumbers : true,
							...
							{name : 'ID',id : 'ID',sortable : false,formatter : waitCanceledActionFormatter,width:50} 
							],
							rowNum : 10,
							autowidth : true,
							rowList : [ 10, 20, 30 ],
