 ...
 */
@Namespace("/assess")
@Results({ @Result(name = "list", location = "/assess/yearappraise/assess_year_appraise_list.jsp") })
@Action("/assessYearAppraiseListAction")
public class AssessYearAppraiseListAction extends
