...
@Namespace("/assess")
@Results({
		@Result(name = "view", location = "/assess/monthappraise/assess_month_appraise_view.jsp"),
		@Result(name = "input", location = "/assess/monthappraise/assess_month_appraise_input.jsp"),
		@Result(name = "input_second", location = "/assess/monthappraise/assess_month_appraise_input_second.jsp") })
@Action("/assessMonthAppraiseAction")
public class AssessMonthAppraiseAction extends
	...
	public String save() {
		...
		String url = "/assess/assessMonthAppraiseAction!input.action?tableType="
		...
		super.addMessage("月度考核评分成功！", url, SysConstant.SUCCESS);
		return SUCCESS;
	}
