...
var jqgrid=jQuery("#workordergrid").jqGrid({    
	url: "${ctx}/workflow/workOrderCancelAction!canceledListdata.action",   
...
<body>
	<form id="workorderForm" name="form">
		<div id="header">
			<div class="title_bg">
				<div class="title">当前位置-已取消任务</div>
			</div>
			<div id="accordion">
				<h3>
				...
				<div class="tabcontent">
					<table cellspacing="0" cellpadding="0" border="0" align="center">
						...
						<tr>
							<th>工单类型：</th>
							<td>
								<baseinfo:dicselector name="taskType" style="width:220px;" columntype="TASK_CODE" type="select" cssClass="inputtext" keyValue="${taskType}" isQuery="query"></baseinfo:dicselector>
							</td>
							<th>建单人：</th>
							<td>
								<input id="workorder_creater_name" style="width:220px;" name="createrName" value="${createrName }" class="inputtext" type="text" />
							</td>
						</tr>
						</tbody>
						<tr>
							<td colspan="4" align="center">
								...
								<baseinfo:expexcel cls="exprotButton"  businessId="workorder_canceled_list" name="导出excel"></baseinfo:expexcel>
							</td>
						</tr>
					</table>
				</div>
