		...
		<div class="tabout" id="detailTb">
			<table border="0" align="center" cellpadding="3" cellspacing="0">
				...
				<tr>
					<th>市县分公司名称</th>
					<td>
						中国移动通信集团${regionName }有限公司<baseinfo:region displayProperty="REGIONNAME" id="${assessExaminationResult.regionId }"></baseinfo:region>分公司
					</td>
					<th>代维单位名称</th>
					<td>
				...
				<tr>
					...
					<th>考核成绩</th>
					<td>
						<fmt:formatNumber value="${assessExaminationResult.score }" pattern="#0.00" />
					</td>
				</tr>
				<tr>
					<td colspan="4">
						<table id="MonthKH">
							<thead>
								<tr>
									<th colspan="${assessExaminationResult.level}" style="width:80px;" nowrap>考核项目</th>
							...
							<tbody>
								<c:forEach var="item" items="${assessExaminationResult.detailList}">
									<tr>
