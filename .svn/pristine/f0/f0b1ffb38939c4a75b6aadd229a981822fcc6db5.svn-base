...
In.add('oe_dispatchtask_list',{path:'${ctx}/workflow/electricity/security/js/oe_dispatchtask_draft_list.js',type:'js',charset:'utf-8',rely:['oe_dispatchtask_common']});
...
In.add('layoutjs',{path:'${ctx}/js/jQuery/layout/jquery.layout-latest.min.js',type:'js',charset:'utf-8',rely:['layout']});
	...
	accordionObj=jQuery("#accordion").accordion({
		...
		var jqgrid = jQuery("#oedispatchtaskgrid").jqGrid({
							url : "${ctx}/workflow/oeDispatchTaskDraftAction!listData.action?",
							datatype : "json",mtype : 'GET',rownumbers : true,
							colNames : [ '标题','工单号','处理人','处理时限', '站点名称', '站点类型', '维护单位', '派单人','派单时间', '操作' ],
							colModel : [ 
										...
										{name : 'ID',id : 'ID',sortable : false,formatter : draftOperationFormatter,width:80} 
							],
						...
						<table cellspacing="0" cellpadding="0" border="0" align="center">
							...
							<tr>
								<td align="center" colspan="4">
									...
									<baseinfo:expexcel cls="exprotButton" businessId="oedispatchtaskdraftlist" name="导出excel"></baseinfo:expexcel>
								</td>
							</tr>
						</table>
					</div>
