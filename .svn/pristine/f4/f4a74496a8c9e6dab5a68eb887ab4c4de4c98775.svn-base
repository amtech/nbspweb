...
<script>
  ...
  var jqgrid=jQuery("#plangrid").jqGrid({    
		url: "${ctx}/analysis/planAnalysisAction!planfinishratelist.action",   
		datatype: "json",    
		mtype: 'GET',
		rownumbers: true,
		colNames:['ID','名称','维护资源总数', '计划巡检资源数','已巡检站点数','未计划资源数','巡检计划完成率','已巡检资源覆盖率'],
		colModel:[
		          {name:'ID',id:'ID',sortable:false,hidden:true},
		          {name:'NAME',id:'NAME',sortable:false,formatter:planfinishorgFmatter},
		          {name:'RESNUM',id:'RESNUM',sortable:false},
		          {name:'PLANNUM',id:'PLANNUM',sortable:false},
		          {name:'DEALNUM',id:'DEALNUM',sortable:false},
		          {name:'UNPLANNUM',id:'UNPLANNUM',sortable:false},
		          {name:'DEARATE',id:'DEARATE',sortable:false},
        ...
        subGridRowExpanded: function(subgrid_id, row_id) {
        	            ...
        	            jQuery("#" + subgrid_table_id).jqGrid({  
        	                url: "${ctx}/analysis/planAnalysisAction!planfinishratesublist.action",  //   
        	                datatype: "json",  
        	                postData: {
        	        		...
        	        		colModel:[
        	        		          {name:'ID',id:'ID',sortable:false,hidden:true},
        	        		          {name:'NAME',id:'NAME',sortable:false,formatter:planfinishgroupFmatter},
        	        		          {name:'RESNUM',id:'RESNUM',sortable:false},
        	        		          {name:'PLANNUM',id:'PLANNUM',sortable:false},
        	        		          {name:'DEALNUM',id:'DEALNUM',sortable:false},
        	        		          {name:'UNPLANNUM',id:'UNPLANNUM',sortable:false},
...
<body>
	<form id="troubleForm" name="troubleForm">
		<div id="header">
			<div class="title_bg">
				<div id="title" class="title">当前位置-计划巡检完成率</div>
			</div>
