 ...
 */
@Namespace("/analysis")
@Results({ @Result(name = "list", location = "/analysis/station_patrol_result_analyse.jsp") })
@Action("/stationPatrolResultAnalysisAction")
public class StationPatrolResultAnalysisAction extends
		BaseAction<String, String> {
	/**
	 * 序列化编号
	 */
	 ...
	 * 站点巡检结果查询统计服务
	 */
	@Resource(name = "stationPatrolResultAnalyseServiceImpl")
	...
	public Map<String, Object> getParameters() {
		...
		map.put("stationName", getParameter("stationName"));
