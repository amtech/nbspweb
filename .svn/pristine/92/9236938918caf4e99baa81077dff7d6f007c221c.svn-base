...
/**
 ...
 function moveSelected(oSourceSel,oTargetSel)
 {
     ...
     for(var i=0; i<arrSelText.length; i++)  
     {
         ...
         oTargetSel.options.length=oTargetSel.options.length+1;
         oTargetSel.options[oTargetSel.options.length-1]=oOption;
         //删除源列表框中的对应项
