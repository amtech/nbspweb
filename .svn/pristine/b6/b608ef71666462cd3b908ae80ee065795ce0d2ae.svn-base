 ...
 */
@Namespace("/assess")
@Results({ @Result(name = "list", location = "/assess/monthappraise/assess_month_appraise_list.jsp") })
@Action("/assessMonthAppraiseListAction")
public class AssessMonthAppraiseListAction extends
	 ...
	 * 考核/检查结果业务服务
	 */
	@Resource(name = "assessAppraiseListServiceImpl")
	private AssessAppraiseListService assessAppraiseListService;
	...
	public void listData() {
		...
		assessAppraiseListService.queryResultPage(parameter, page);
