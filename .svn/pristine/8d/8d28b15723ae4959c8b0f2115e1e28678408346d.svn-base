...
In.add('wmaintain_common',{path:'${ctx}/workflow/wmaintain/js/wmaintain_common.js',type:'js',charset:'utf-8'});
	In.ready('jgcn', 'common', 'wdatejs', 'wmaintain_common', function() {
		...
		var jqgrid = jQuery("#wmaintaingrid")
				.jqGrid(
						{
							url : "${ctx}/workflow/wmaintainHandleAction!waitHandleListData.action?",
							datatype : "json",
							mtype : 'POST',
							rownumbers : true,
							...
							colModel : [ 
										...
										{name : 'ID',id : 'ID',sortable : false,formatter : waitHandledActionFormatter,width:50} 
							],
							rowNum : 10,
							autowidth : true,
							rowList : [ 10, 20, 30 ],
					...
					<table cellspacing="0" cellpadding="0" border="0" align="center">
						...
						<tr>
							<td colspan="4" align="center">
								...
								<baseinfo:expexcel cls="exprotButton"  businessId="wmaintainwaithandledlist" name="导出excel"></baseinfo:expexcel>
							</td>
						</tr>
					</table>
				</div>
