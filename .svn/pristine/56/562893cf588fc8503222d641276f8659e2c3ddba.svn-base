...
In.add('wmaintain_common',{path:'${ctx}/workflow/wmaintain/js/wmaintain_common.js',type:'js',charset:'utf-8'});
	In.ready('jgcn', 'common', 'wdatejs', 'wmaintain_common', function() {
		...
		var jqgrid = jQuery("#wmaintaingrid")
				.jqGrid(
						{
							url : "${ctx}/workflow/wmaintainDraftAction!listData.action?",
							datatype : "json",
							mtype : 'POST',
							rownumbers : true,
							...
							colModel : [ 
										...
										{name : 'ID',id : 'ID',sortable : false,formatter : draftOperateionActionFormatter,width:80} 
							],
							rowNum : 10,
							autowidth : true,
							rowList : [ 10, 20, 30 ],
