...
@Namespace("/assess")
@Results({
		@Result(name = "input", location = "/assess/monthappraise/assess_month_appraise_confirm.jsp"),
		@Result(name = "list", location = "/assess/monthappraise/assess_month_appraise_confirm_list.jsp") })
@Action("/assessMonthAppraiseConfirmAction")
public class AssessMonthAppraiseConfirmAction extends
	...
	private AssessMonthAppraiseWorkflowService workflowService;
	/**
	 * 考核/检查结果表单数据
	 */
	...
	public String input() {
		...
		super.getRequest().setAttribute("tableType",
				AssessExaminationResult.MONTH_ASSESS_);
	...
	public String save() {
		...
		super.addMessage("月度考核评分确认成功！", url, SysConstant.SUCCESS);
		return SUCCESS;
	}
