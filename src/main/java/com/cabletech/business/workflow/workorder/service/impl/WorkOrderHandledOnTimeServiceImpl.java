...
import com.cabletech.business.workflow.workorder.dao.WorkOrderHandledOnTimeDao;
import com.cabletech.business.workflow.workorder.service.WorkOrderHandledOnTimeService;
...
@Service
public class WorkOrderHandledOnTimeServiceImpl extends BaseServiceImpl
		implements WorkOrderHandledOnTimeService {
	// 及时工单查询Dao
	@Resource(name = "workOrderHandledOnTimeDao")
	private WorkOrderHandledOnTimeDao workOrderHandledOnTimeDao;
	...
	public Page list(Page<Map<String, Object>> page,
		...
		return workOrderHandledOnTimeDao.getList(page, condition.toString());
	}

	protected BaseDao getBaseDao() {
		return workOrderHandledOnTimeDao;
	}
}
