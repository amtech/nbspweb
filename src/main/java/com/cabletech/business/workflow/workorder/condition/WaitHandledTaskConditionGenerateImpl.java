 ...
 */
@Component
public class WaitHandledTaskConditionGenerateImpl extends BaseConditionGenerate {
	/**
	 * 根据查询参数来设置查询的sql条件语句
	 * 
	 * @param parameter
	...
	/**
	 * 获取变动连接表单数据信息的sql语句（与待办工作视图进行关联）
	 * 
	...
	public String getJoinTableSql() {
		...
		sqlBuf.append(" JOIN ( ");
		sqlBuf.append(" SELECT jbpm.BZID,jbpm.TASKID,jbpm.TASKID AS STEP, ");
		sqlBuf.append(" jbpm.TASKNAME AS PROINST_TASK_STATE,jbpm.RES AS PROCESS_URL ");
