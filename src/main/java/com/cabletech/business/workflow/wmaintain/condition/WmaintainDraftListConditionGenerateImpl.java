...
/**
 * 隐患维修作业计划草稿箱查询条件生成器接口实现
 * 
 * @author 杨隽 2012-04-16 创建
 * 
 */
@Component
public class WmaintainDraftListConditionGenerateImpl extends
	...
	public void setQuerySql(QueryParameter parameter) {
		...
		super.putPlanStateCondition(
				WMaintainPlan.WMAINTAIN_PLAN_NOTSUBMITED_STATE, true);
