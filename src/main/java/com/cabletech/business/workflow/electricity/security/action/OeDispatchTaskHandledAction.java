 ...
 */
@Namespace("/workflow")
@Results({ @Result(name = "list", location = "/workflow/electricity/security/oe_dispatchtask_handled_list.jsp") })
@Action("/oeDispatchTaskHandledAction")
public class OeDispatchTaskHandledAction extends
	...
	// 供电保障已办业务处理
	@Resource(name = "oeDispatchTaskHandledServiceImpl")
	private OeDispatchTaskHandledService oeDispatchTaskHandledService;
	...
	public void listData() {
		...
		Page page = oeDispatchTaskHandledService.getHandledList(oeDispatchTask);
