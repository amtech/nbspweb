 ...
 */
@Service
public class LocalePhotosConditionGenerate implements ConditionGenerate {
	...
	public void setQuerySql(QueryParameter parameter) {
		...
		if (!QueryParameter.isNull(localeProcess)) {
			parameter.setAlias("aao");
			parameter.setColumnName("entity_id");
			...
			parameter.setAlias("aao");
			parameter.setColumnName("entity_type");
