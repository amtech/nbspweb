...
In.add('oe_dispatchtask_list',{path:'${ctx}/workflow/electricity/security/js/oe_dispatchtask_handled_list.js',type:'js',charset:'utf-8',rely:['oe_dispatchtask_common']});
...
In.add('layoutjs',{path:'${ctx}/js/jQuery/layout/jquery.layout-latest.min.js',type:'js',charset:'utf-8',rely:['layout']});
	...
	accordionObj=jQuery("#accordion").accordion({
		...
		var jqgrid = jQuery("#oedispatchtaskgrid").jqGrid({
							url : "${ctx}/workflow/oeDispatchTaskHandledAction!listData.action?",
							...
							colModel : [ 
										...
										{name : 'ID',id : 'ID',sortable : false,formatter : handledOperationFormatter,width:60} 
							],
						...
						<table cellspacing="0" cellpadding="0" border="0" align="center">
							...
							<tr>
								<td align="center" colspan="4">
									...
									<baseinfo:expexcel cls="exprotButton" businessId="oedispatchtaskhandledlist" name="导出excel"></baseinfo:expexcel>
								</td>
							</tr>
						</table>
					</div>
