...
In.add('wmaintain_common',{path:'${ctx}/workflow/wmaintain/js/wmaintain_common.js',type:'js',charset:'utf-8'});
	In.ready('jgcn', 'common', 'wdatejs', 'wmaintain_common', function() {
		...
		var jqgrid = jQuery("#wmaintaingrid")
				.jqGrid(
						{
							url : "${ctx}/workflow/wmaintainQueryAction!listData.action?",
							datatype : "json",
							mtype : 'POST',
							rownumbers : true,
					...
					<table cellspacing="0" cellpadding="0" border="0" align="center">
						...
						<tr>
							<td colspan="4" align="center">
								...
								<baseinfo:expexcel cls="exprotButton"  businessId="wmaintainquerylist" name="导出excel"></baseinfo:expexcel>
							</td>
						</tr>
					</table>
				</div>
