...
In.add('layoutjs',{path:'${ctx}/js/jQuery/layout/jquery.layout-latest.min.js',type:'js',charset:'utf-8',rely:['layout']});
	...
	accordionObj=jQuery("#accordion").accordion({
		...
		var jqgrid=jQuery("#faultgrid").jqGrid({    
			url: "${ctx}/workflow/faultDispatchHandledAction!listdata.action?",   
			datatype: "json",mtype: 'GET',rownumbers: true,
			colNames:['故障单标题','工单号','EOMS单号', '故障发生时间','故障发生地点','故障站点','是否紧急','发现方式','处理人','处理时限','状态','操作','专业类型'],
			colModel:[
			          ...
			          {name:'TASK_STATE',id:'TASK_STATE',sortable:false,formatter:stateViewFormatter,width:80},
			          {name:'DISPATCH_ID',id:'DISPATCH_ID',sortable:false,formatter:faultDispatchViewFmatter,width:60},
...
<body>
		<form id="optForm" method="post" action="${ctx }/workflow/faultDispatchHandledAction!listdate.action">
			<div>
				<div class="title_bg">
						...
						<table cellspacing="0" cellpadding="0" border="0" align="center">
							...
							<tr>
								<td align="center" colspan="4">
									...
									<baseinfo:expexcel cls="exprotButton" businessId="faultdispatchhandledlist" name="导出excel"></baseinfo:expexcel>
								</td>
							</tr>
						</table>
					</div>
