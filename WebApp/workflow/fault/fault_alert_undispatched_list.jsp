...
In.add('fault-list', {path : '${ctx}/workflow/fault/js/fault_alert_undispatched_list.js',type : 'js',charset : 'utf-8',rely:['fault-common']});
...
In.add('layoutjs',{path:'${ctx}/js/jQuery/layout/jquery.layout-latest.min.js',type:'js',charset:'utf-8',rely:['layout']});
	...
	accordionObj=jQuery("#accordion").accordion({
		...
		var jqgrid = jQuery("#faultgrid").jqGrid({
							url : "${ctx}/workflow/faultAlertAction!unDispatchedListdata.action?",
							datatype : "json",mtype : 'GET',rownumbers : true,
							colNames : [ '故障单标题', 'EOMS单号', '故障发生时间', '故障发生地点',
									'故障站点', '是否紧急', '发现方式', '故障告警单状态', '操作','专业类型' ],
							colModel : [ 
								          ...
								          {name : 'ID',id : 'ID',sortable : false,formatter : unDispatchedfaultFmatter,width:60},
							...
							jsonReader : {
								root : "result",page : "pageNo",total : "totalPages", // 总页数 
						...
						<table cellspacing="0" cellpadding="0" border="0" align="center">
							...
							<tr>
								<td align="center" colspan="4">
									...
									<baseinfo:expexcel cls="exprotButton" businessId="faultalertundispatchedlist" name="导出excel"></baseinfo:expexcel>
								</td>
							</tr>
						</table>
					</div>
