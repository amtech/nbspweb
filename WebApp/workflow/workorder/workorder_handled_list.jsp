...
In.add('layoutjs',{path:'${ctx}/js/jQuery/layout/jquery.layout-latest.min.js',type:'js',charset:'utf-8',rely:['layout']});
  ...
  var jqgrid=jQuery("#workordergrid").jqGrid({    
		url: "${ctx}/workflow/workOrderHandledAction!listdata.action",   
		...
		colModel:[
		          ...
		          {name:'ID',id:'ID',sortable:false,formatter:HanledActionFmatter,width:80},
				...
				<div class="tabcontent">
					<table cellspacing="0" cellpadding="0" border="0" align="center">
						<tr>
							<th>标题：</th>
							<td>
								<input id="taskName" name="taskName" class="inputtext" type="text" maxlength="60" style="width:220px;" />
							</td>
							<th>建单日期：</th>
							<td>
						...
						<tr>
							<td colspan="4" align="center">
								...
								<baseinfo:expexcel cls="exprotButton"  businessId="workorder_handled_list" name="导出excel"></baseinfo:expexcel>
							</td>
						</tr>
					</table>
				</div>
