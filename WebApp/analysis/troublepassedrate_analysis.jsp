...
<script>
  ...
  var jqgrid=jQuery("#troublegrid").jqGrid({    
		url: "${ctx}/analysis/troubleAnalysisAction!approvepasslist.action",   
		datatype: "json",    
		mtype: 'GET',
		rownumbers: true,
		colNames:['ID','名称','一次通过数','一次通过率','两次通过数','二次通过率','故障工单总数'],
		colModel:[
        ...
        subGridRowExpanded: function(subgrid_id, row_id) {
        	            ...
        	            jQuery("#" + subgrid_table_id).jqGrid({  
        	                url: "${ctx}/analysis/troubleAnalysisAction!approvepasssublist.action",  //   
        	                datatype: "json",  
        	                postData: {
