...
<script>
  ...
  var jqgrid=jQuery("#workordergrid").jqGrid({    
		url: "${ctx}/analysis/workOrderAnalysisAction!prossetimelyratelist.action",   
		datatype: "json",    
		mtype: 'GET',
		rownumbers: true,
		colNames:['ID','名称','处理及时工单数','超时工单数','工单总数','工单处理及时率'],
		colModel:[
		          {name:'ID',id:'ID',sortable:false,hidden:true},
		          {name:'NAME',id:'NAME',sortable:false,formatter:workordertimelyFmatter},
