...
<script>
  ...
  var jqgrid=jQuery("#troublegrid").jqGrid({    
		url: "${ctx}/analysis/troubleAnalysisAction!timelyprosseratelist.action",   
		datatype: "json",    
		mtype: 'GET',
		rownumbers: true,
		colNames:['ID','名称','处理及时故障工单','故障工单总数', '超时故障工单','故障工单处理及时率'],
		colModel:[
		          {name:'ID',id:'ID',sortable:false,hidden:true},
		          {name:'NAME',id:'NAME',sortable:false,formatter:timelyprosseorgFmatter},
        ...
        subGridRowExpanded: function(subgrid_id, row_id) {
        	            ...
        	            jQuery("#" + subgrid_table_id).jqGrid({  
        	                url: "${ctx}/analysis/troubleAnalysisAction!timelyprosseratesublist.action",  //   
        	                datatype: "json",  
        	                postData: {
        	                ...
        	                colModel: [  
        	                    {name:'ID',id:'ID',sortable:false,hidden:true},
		         				{name:'NAME',id:'NAME',sortable:false,formatter:timelyprossegroupFmatter},
		          				{name:'INTIME_NUM',id:'INTIME_NUM',sortable:false},
		          				{name:'ALL_NUM',id:'ALL_NUM',sortable:false},
		          				{name:'OVERTIME_NUM',id:'OVERTIME_NUM',sortable:false},
		          				{name:'INTIME_RATE',id:'INTIME_RATE',sortable:false}
...
<body>
	<form id="troubleForm" name="troubleForm">
		<div id="header">
			<div class="title_bg">
				<div id="title" class="title">当前位置-故障处理及时率</div>
			</div>
