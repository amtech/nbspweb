...
<script>
  ...
  var jqgrid=jQuery("#inworkordergrid").jqGrid({    
		url: "${ctx}/analysis/workOrderDetailAction!ntimespassedlist.action?ntime=1",   
		datatype: "json",    
		mtype: 'GET',
		rownumbers: true,
	...
	jQuery("#overworkordergrid").jqGrid({    
		url: "${ctx}/analysis/workOrderDetailAction!ntimespassedlist.action?ntime=2", 
		datatype: "json",    
		mtype: 'GET',
...
<body>
	<form id="workorderForm" name="workorderForm">
		<div id="header">
			<div class="title_bg">
				<div class="title">当前位置-工单审批明细</div>
			</div>
		...
		<div id="content" align="center" style="padding-top: 2px">
			<div id="tab_process">
				<ul>
					<li><a href="#inworkorder">一次通过明细</a></li>
					<li><a href="#overworkorder">二次通过明细</a></li>
