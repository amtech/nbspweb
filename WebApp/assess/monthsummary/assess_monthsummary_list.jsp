...
<body>
	<form
		action="${ctx }/assess/assessMonthSummaryAction!getmonthsummary.action"
		id="assesstemplateForm" method="post">
		<div class="title_bg">
			<div id="title" class="title">当前位置-月度考核汇总</div>
		</div>
		<div class="tabcontent">
			<table cellspacing="0" cellpadding="0" border="0" align="center">
				<tr>
					<th>区域:</th>
					<td><input id="regionname" name="regionname" class="treetext"
				...
				<tr>
					<td colspan="4" align="center"><input type="submit"
						class="button" value="查询" /> <baseinfo:expexcel
							cls="exprotButton" businessId="assess_monthsummary_list"
			...
			<table id="KH">
				<thead>
					<tr>
						...
						<th style="width:120px;" nowrap="nowrap">维护专业</th>
						<th style="width:120px;" nowrap="nowrap">考核成绩</th>
					</tr>
				</thead>
				<tbody>
