...
In.ready('vam', 'common', 'wdatejs',function() {
	...
	<body>
		<form action="${ctx }/assess/assessYearAppraiseAction!inputSecond.action" id="inputForm" name="inputForm" method="post">
			<div class="title_bg">
			...
			<div class="tabcontent">
				<table border="0" align="center" cellpadding="3" cellspacing="0">
					<tr>
						<th>考核年份</th>
						<td>
							<fmt:formatDate value="${assessExaminationResult.appraiseMonth }" pattern="yyyy" var="yearmonth" />
							<input id="yearmonth" name="yearmonth" type="text" class="Wdate inputtext required" value="${yearmonth }" style="width: 220px;" onfocus="WdatePicker({dateFmt:'yyyy',maxDate:'%y'})" />
