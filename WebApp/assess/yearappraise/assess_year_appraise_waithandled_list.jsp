...
In.add('wdatejs',{path:'${ctx}/js/WdatePicker/WdatePicker.js',type:'js',charset:'utf-8'});
	In.ready('jgcn', 'common', 'wdatejs', function() {
		...
		var jqgrid=jQuery("#assessgrid").jqGrid({    
			url: "${ctx}/assess/assessYearAppraiseWaitHandledAction!listData.action?",   
			datatype: "json",    
			mtype: 'GET',
			rownumbers: true,
			colNames:['考核表名称','考核年份', '代维公司','考核成绩','考核人','考核时间','操作'],
			colModel:[
	...
	function toDoTaskForm(url){
		window.location.href = "${ctx}"+url+"&tableType=02";
	}
