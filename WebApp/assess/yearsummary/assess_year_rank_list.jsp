...
<c:if test="${not empty dataMap }">
	<table align="center">
		<tr>
			<th style="width:150px;text-align:center;">排名</th>
		...
		<c:forEach var="oneData" items="${dataMap.resultList }" varStatus="status">
			<tr>
				<td style="width:150px;text-align:center;">${status.index+1 }</td>
