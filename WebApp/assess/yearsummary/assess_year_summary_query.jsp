...
In.add('wdatejs',{path:'${ctx}/js/WdatePicker/WdatePicker.js',type:'js',charset:'utf-8'});
	...
	function exportXls(){
		...
		location="${ctx}/assess/assessYearSummaryAction!summaryExport.action?yearmonth="+yearmonth;
	}
	/**
	 * 列表查询方法
	 */
	function queryData() {
		...
		yearmonth+="-01-01";
		var actionUrl="${ctx}/assess/assessYearSummaryAction!summaryList.action?yearmonth="+yearmonth;
