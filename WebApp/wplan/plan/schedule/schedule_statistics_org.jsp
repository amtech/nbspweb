...
//使用层布局
		var jqgrid = jQuery("#itemgrid")
				.jqGrid(
						{
							url : "${ctx}/wplan/patrolinfoScheduleAction!statisticsData.action?queryType=byOrg",
							datatype : "json",
							mtype : 'GET',
							rownumbers : true,
							colNames : [ '区域','代维公司','巡检站点数', '隐患站点数', '异常项' ],
							colModel : [{
								name : 'REGIONNAME',
								id : 'REGIONNAME',
								sortable : false
...
function showDetailed(id){
			window.location.href = "${ctx}/wplan/patrolinfoScheduleAction!detailedList.action?queryType=&orgId="+id+"&startTime=${parameters['startTime']}&patrolGroupId=${parameters['patrolGroupId']}&endTime=${parameters['endTime']}&regionId=${parameters['regionId']}";
}
				...
				<table cellspacing="0" cellpadding="0" border="0" align="center">
					<tr>
						...
						<td colspan="3"> 
						    ...
						    &nbsp;&nbsp;<input type="radio" name="queryType" value="byOrg" onclick="weaveCondition('byOrg')" checked>按代维公司
						    </c:if>
					...
					<tr>
						<td colspan="4" align="center">
							...
							<baseinfo:expexcel cls="exprotButton"  businessId="schedule_org" name="导出excel"></baseinfo:expexcel>
						</td>
					</tr>
				</table>
			</div>
