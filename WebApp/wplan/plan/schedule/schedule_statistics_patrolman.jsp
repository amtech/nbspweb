...
In.ready('jgcn', 'common', 'wdatejs', 'fault-common','ztreejs','ztreeui', function() {
		...
		var jqgrid = jQuery("#itemgrid")
				.jqGrid(
						{
							url : "${ctx}/wplan/patrolinfoScheduleAction!statisticsData.action?queryType=byPatrolMan",
							datatype : "json",
							mtype : 'GET',
							rownumbers : true,
							colNames : [ '区域','代维公司','巡检组','巡检员','巡检站点数', '隐患站点数', '异常项' ],
							colModel : [{
								name : 'REGIONNAME',
								id : 'REGIONNAME',
								sortable : false
...
function showDetailed(id){
			window.location.href = "${ctx}/wplan/patrolinfoScheduleAction!detailedList.action?queryType=&patrolManId="+id+"&startTime=${parameters['startTime']}&orgId=${parameters['orgId']}&patrolGroupId=${parameters['patrolGroupId']}&endTime=${parameters['endTime']}&regionId=${parameters['regionId']}";
}
				...
				<table cellspacing="0" cellpadding="0" border="0" align="center">
					<tr>
						...
						<td colspan="3"> 
							...
							&nbsp;&nbsp;<input type="radio" name="queryType" value="byPatrolMan" onclick="weaveCondition('byPatrolMan')" checked>按巡检员
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						<td colspan="4" align="center">
							...
							<baseinfo:expexcel cls="exprotButton"  businessId="schedule_patrolman" name="导出excel"></baseinfo:expexcel>
						</td>
					</tr>
				</table>
			</div>
