...
In.add('highcharts', {path :'${ctx}/js/highchart/highcharts.js',type : 'js',charset : 'utf-8'});
			...
			<div class="tabcontent">
				<table cellspacing="0" cellpadding="0" border="0" align="center">
					<tr>
						...
						<td>
							${patrolanalyMap.PLANCOUNT}
						</td>
						<th>
							计划巡检站点数：
						</th>
						<td>
							${patrolanalyMap.PLANRESCOUNT}
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							${patrolanalyMap.PLANOVERRESCOUNT}
						</td>
						<th>
							巡检率：
						</th>
						<td>
							${patrolanalyMap.PLANRATE}
						</td>
					</tr>
					<tr>
						<td colspan="4">
							<div id="tab_process">
								<ul>
									<li>
										<a href="#orginfo">代维公司情况</a>
									</li>
									<li>
										<a href="#patrolinfo">计划完成情况</a>
									</li>
									<li>
										<a href="#regioninfo">区域完成情况</a>
									</li>
									<li>
										<a href="#chartinfo">图表</a>
									</li>
								</ul>
								<div id="orginfo">
								...
								<div id="regioninfo">
									<table id="regioninfogrid"></table>
									<div id="regioninfopager"></div>
								</div>
	...
	In.ready('jgcn', 'highcharts', 'common', 'patrolinfo_analysis', function() {
		...
		var endtime='${endtime }';
			...
			var initialized = [false,false,false,false]; //是否已初始化
			...
			patrolInfo([${PatrolOrgChartMap.PATROLNAMES}],[${PatrolOrgChartMap.RESCOUNTS}],[${PatrolOrgChartMap.NORESCOUNTS}],[${PatrolOrgChartMap.ALRESCOUNTS}]);
	});
	</script>
</html>