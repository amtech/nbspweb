...
<body>
	<form action="${ctx }/wplan/patrolanalysisAction!showorg.action"
		id="patrolinfoForm" name="patrolinfoForm" method="post">
		<div id="header">
			<div class="title_bg">
				<div id="title" class="title">当前位置-按代维分析</div>
			</div>
				...
				<table cellspacing="0" cellpadding="0" border="0" align="center">
					<tr>
						...
						<td><input id="orgname" name="orgname"
							class="inputtext required" readonly="readonly" /><a
							href="javascript:searchOrg('${ctx}/commonaccess!getorg.action?orgtype=2');"><img
								<img border="0"
								src="${ctx}/css/image/orgselect.png" />
						</a><input id="orgid" name="orgid" type="hidden" /><span
					...
					<tr>
						...
						<td><baseinfo:customselector name="plantype" id="plantype"
								...
								onChange="plantypechange();"></baseinfo:customselector>
						</td>
					</tr>
					<tr>
						<th>统计时间：</th>
					...
					<tr>
						<td colspan="2" align="center"><input type="submit"
							...
							type="reset" class="button" value="清除" />
						</td>
